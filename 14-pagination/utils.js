function listagem_generica_paginada(nome_classe, nome_div, lista_campos, elemento_html, html_antes, html_depois, pagina_atual) {

    // chamada ao backend
    var rota = `http://localhost:5000/listar_paginado/${nome_classe}/${pagina_atual}`;
